...
Interceptor.replace(ptrWSASend, new NativeCallback(function (s, lpBuffers, dwBufferCount, lpNumberOfBytesSent, dwFlags, lpOverlapped, lpCompletionRoutine) {
    ...
    // Eğer WSASend'yi devre dışı bırakmamışsak, fonksiyonu çağırıyoruz
    if(!DISABLE_WSASEND) {
...
// WSAStartup fonksiyonunu izliyoruz
...
// WSAAddressToStringW fonksiyonunu izliyoruz
...
// ShellExecuteExW fonksiyonunu izliyoruz
...
Interceptor.replace(ptrShellExecute, new NativeCallback(function (executeinfo) {
    ...
    // Shell komutlarını geçirebilmek için bu satırı yorum satırına alıyoruz
